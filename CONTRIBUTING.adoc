...
= Contributing — Axiology.jl
:toc: left

Contributions to `Axiology.jl` follow the Hyperpolymath estate conventions:
...
# Or, with a configured GitHub SSH key:
# git clone git@github.com:hyperpolymath/Axiology.jl.git
cd Axiology.jl
