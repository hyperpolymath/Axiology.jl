...
git clone <https://github.com/hyperpolymath/Axiology.jl.git> cd
Axiology.jl
...
toolbox create Axiology.jl-dev toolbox enter Axiology.jl-dev \# Install
...
Axiology.jl/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
