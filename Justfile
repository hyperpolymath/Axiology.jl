...
doctor:
    @echo "Running diagnostics for Axiology.jl..."
...
help-me:
    @echo "=== Axiology.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/Axiology.jl/issues/new"
    @echo ""
